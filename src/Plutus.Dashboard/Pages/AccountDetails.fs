...
module View =
    ...
    let private modeBadge (isSandbox: bool) =
        if isSandbox then
            ...
            _span [ _class_ "px-3 py-1 rounded text-sm font-medium bg-slate-100 text-slate-700" ] [
    ...
    let private timestampsSection (account: AccountDetailsInfo) =
        _div [] [
            _h3 [ _class_ "text-sm font-semibold text-slate-700 mb-3 uppercase tracking-wide" ] [ Text.raw "Activity" ]
            _dl [ _class_ "space-y-3" ] [
                    ...
                    _div [
                        ...
                        _div [ _class_ "px-6 py-6" ] [
                            ...
                            _div [ _class_ "flex items-center space-x-4 mb-6 pb-6 border-b" ] [
                                ...
                                _div [] [
                                    _h2 [ _class_ "text-xl font-bold text-slate-900" ] [
                                        Text.raw (account.MarketType.ToString())
                                    ]
                                    _p [ _class_ "text-slate-500" ] [
                                        Text.raw (
                            ...
                            if account.IsSandbox then
                                _div [ _class_ "mt-6 bg-slate-50 border border-slate-200 rounded-md p-4" ] [
                                    _div [ _class_ "flex" ] [
                                        _div [ _class_ "flex-shrink-0" ] [
                                            _i [ _class_ "fas fa-info-circle text-slate-500" ] []
                                        ]
                                        _div [ _class_ "ml-3" ] [
                                            _p [ _class_ "text-sm text-slate-500" ] [
                                                Text.raw
