...
module View =
    ...
    let private apiKeyField (maskedValue: string) =
        _div [] [
            _label [ _for_ "apiKey"; _class_ "block text-sm font-medium text-slate-600 mb-1.5" ] [ Text.raw "API Key" ]
            _input [
                _id_ "apiKey"
                _name_ "apiKey"
                _type_ "password"
                    ...
                    _div [
                        ...
                        _form [
                            ...
                            _div [ _class_ "px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto" ] [
                                _div [] [
                                    _label [ _class_ "block text-sm font-medium text-slate-600 mb-1.5" ] [
                                        Text.raw "Exchange"
                                    ]
                                    _div [
                                        _class_
            ...
            _div [ _class_ "fixed inset-0 z-10 overflow-y-auto" ] [
                _div [ _class_ "flex min-h-full items-center justify-center p-4" ] [
                    _div [
                        ...
                        _h3 [ _class_ "text-lg font-semibold text-slate-900 mb-2" ] [ Text.raw "Account Updated!" ]
            ...
            _div [ _class_ "fixed inset-0 z-10 overflow-y-auto" ] [
                _div [ _class_ "flex min-h-full items-center justify-center p-4" ] [
                    _div [
                        ...
                        _h3 [ _class_ "text-lg font-semibold text-slate-900 mb-2" ] [ Text.raw "Account Deleted" ]
                        _p [ _class_ "text-slate-600 mb-4" ] [ Text.raw "The account has been removed successfully." ]
                        _button [
                            _type_ "button"
                            _class_
                                "px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white font-medium text-sm rounded-md transition-colors"
            ...
            _div [ _class_ "fixed inset-0 z-10 overflow-y-auto" ] [
                _div [ _class_ "flex min-h-full items-center justify-center p-4" ] [
                    _div [
                        ...
                        _h3 [ _class_ "text-lg font-semibold text-slate-900 mb-2" ] [ Text.raw "Account Not Found" ]
                        _p [ _class_ "text-slate-600 mb-4" ] [ Text.raw "The requested account could not be found." ]
                        _button [
                            _type_ "button"
                            _class_
                                "px-4 py-2 text-slate-600 hover:bg-slate-100 font-medium text-sm rounded-md transition-colors"
