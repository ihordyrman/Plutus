...
module View =
    ...
    let private logo =
        _div [ _class_ "flex items-center justify-center mb-8" ] [
            _div [ _class_ "w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center" ] [
        ...
        _div [ _class_ "mb-4" ] [
            ...
            _div [ _class_ "relative" ] [
                ...
                _input [
                    ...
                    _required_
                    _class_ "w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all"
                ]
            ]
        ]
    ...
    let private rememberMeCheckbox =
        _div [ _class_ "flex items-center mb-6" ] [
            ...
            _label [ _for_ "rememberMe"; _class_ "ml-2 text-sm text-slate-600" ] [ Text.raw "Remember me for 30 days" ]
        ]
    ...
    let loginForm (error: string option) =
        _html [] [
            headContent
            _body [ _class_ "min-h-screen bg-slate-50 flex items-center justify-center p-4" ] [
                _div [ _class_ "w-full max-w-sm" ] [
                    logo
                    _div [ _class_ "bg-white rounded-xl shadow-sm border border-slate-200 p-8" ] [
                        _h1 [ _class_ "text-xl font-semibold text-slate-900 text-center mb-2" ] [ Text.raw "Welcome back" ]
                        _p [ _class_ "text-sm text-slate-500 text-center mb-6" ] [ Text.raw "Sign in to your account" ]
                        errorMessage error
                        _form [ _method_ "POST"; _action_ "/login" ] [
                            ...
                            _button [
                                _type_ "submit"
                                _class_ "w-full bg-slate-900 text-white py-2.5 px-4 rounded-lg text-sm font-medium hover:bg-slate-800 transition-colors"
                            ] [ Text.raw "Sign in" ]
                        ]
                    ]
        ...
        _html [] [
            ...
            _body [ _class_ "min-h-screen bg-slate-50 flex items-center justify-center p-4" ] [
                _div [ _class_ "w-full max-w-sm" ] [
                    logo
                    _div [ _class_ "bg-white rounded-xl shadow-sm border border-slate-200 p-8" ] [
                        _h1 [ _class_ "text-xl font-semibold text-slate-900 text-center mb-2" ] [ Text.raw "Create Admin Account" ]
                        _p [ _class_ "text-sm text-slate-500 text-center mb-6" ] [ Text.raw "Set up your first administrator account" ]
                        errorMessage error
                        _form [ _method_ "POST"; _action_ "/setup" ] [
                            ...
                            _button [
                                _type_ "submit"
                                _class_ "w-full bg-slate-900 text-white py-2.5 px-4 rounded-lg text-sm font-medium hover:bg-slate-800 transition-colors mt-2"
