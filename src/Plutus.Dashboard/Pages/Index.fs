...
let private statsPill icon label countEndpoint subLabel iconColorClass bgColorClass =
    _div
        [ _class_
              $"flex-1 min-w-[180px] group flex items-center gap-3 px-4 py-2.5 rounded-lg {bgColorClass} border border-slate-200 hover:border-slate-300 hover:shadow-sm transition-all cursor-default" ]
        [ _div
              [ _class_ $"w-8 h-8 rounded-lg flex items-center justify-center bg-white shadow-sm" ]
              [ _i [ _class_ $"fas {icon} text-sm {iconColorClass}" ] [] ]
          _div
              [ _class_ "flex flex-col" ]
              [ _div
            ...
            [ _head
              ...
              _body
                  ...
                  [ header
                    ...
                    _div
                        [ _id_ "main-content"; _class_ "max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-6" ]
                        [ _div
