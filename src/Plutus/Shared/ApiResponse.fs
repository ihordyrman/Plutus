...
module ApiResponse =
    ...
    let ok (data: obj) : HttpHandler =
        writeJson 200 {| Ok = true; Data = data |}

    let okList (data: obj) (total: int) : HttpHandler =
        writeJson
            200
            {| Ok = true
               Data = data
    ...
    let created (data: obj) : HttpHandler =
        writeJson 201 {| Ok = true; Data = data |}
